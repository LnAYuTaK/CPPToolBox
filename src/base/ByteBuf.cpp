...
const char *ByteBuf::data() const noexcept
{
...
int32_t ByteBuf::capacity() const
{
...
ByteBuf ByteBuf::copy() const
{
    return ByteBuf(d->originData);
}
...
int32_t ByteBuf::readerIndex() const
{
...
int32_t ByteBuf::writerIndex() const
{
...
ByteBuf ByteBuf::getBytes(int32_t index, int32_t dstIndex, int32_t length) const
{
    if (index >= d->originData.length())
    {
        return ByteBuf();
...
uint8_t ByteBuf::getUnsignedChar(int32_t index) const
{
...
uint8_t ByteBuf::readUnsignedChar()
{
    return readChar();
}
...
int16_t ByteBuf::readShortLE()
{
    return d->readTLE<int16_t>(INT16_BIT);
}
uint16_t ByteBuf::readUnsignedShort()
{
    return d->readT<int16_t>(INT16_BIT);
}
...
int32_t ByteBuf::readIntLE()
{
    return d->readTLE<int32_t>(INT32_BIT);
}
uint32_t ByteBuf::readUnsignedInt()
{
    return d->readT<int32_t>(INT32_BIT);
}
uint32_t ByteBuf::readUnsignedIntLE()
{
    return d->readTLE<int32_t>(INT32_BIT);
}
...
int64_t ByteBuf::readLongLE()
{
    return d->readTLE<int64_t>(INT64_BIT);
}
uint64_t ByteBuf::readUnsignedLong()
{
    return d->readT<int64_t>(INT64_BIT);
}
