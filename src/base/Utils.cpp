...
std::string Utils::RawDataToHexStr(const void *data_ptr, uint16_t data_len,
                                   bool uppercase,
...
size_t Utils::HexStrToRawData(const std::string &hex_str, void *out_ptr,
                              uint16_t out_len) {
...
namespace {
static void _HexStrToRawDataWithDelimiter(const std::string &hex_str,
...
static void _HexStrToRawDataWithoutDelimiter(const std::string &hex_str,
                                             std::vector<uint8_t> &out) {
...
size_t Utils::HexStrToRawData(const std::string &hex_str,
                              std::vector<uint8_t> &out,
                              const std::string &delimiter) {
  out.clear();
...
void Utils::Replace(std::string &target_str, const std::string &pattern_str,
